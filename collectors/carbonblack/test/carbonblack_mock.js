...
process.env.paws_api_client_id = "{ \"auditLogEventApiId\": \"YOUR_AUDIT_LOG_EVENT_API_ID\" , \"searchRequestApiId\": \"YOUR_SEARCH_REQUEST_API_ID\" }";
process.env.paws_api_secret = "{ \"auditLogEventApiSecretKey\": \"YOUR_AUDIT_LOG_EVENT_API_SECRET_KEY\", \"searchRequestApiSecretKey\": \"YOUR_SEARCH_REQUEST_API_SECRET_KEY\" }";
