 ...
 *   REQUIRED:
 *     --paws_endpoint=YOUR_OAUTH_DOMAIN
 *     --paws_api_client_id=YOUR_OAUTH_CLIENT_ID
...
const pawsCreds = {
    auth_type: "service2service",
    creds: argv.paws_creds,
    email_id: argv.paws_email_id
};
...
var c = new Collector({}, {aimsCreds, pawsCreds});
