...
function checkO365Subscriptions(callback) {
    let collector = this;
    return o365_mgmnt.listSubscriptions(collector.o365_mgmnt_client)
        ...
        .then(filteredStreams => {
            ...
            const streamPromises = filteredStreams.map(stream => o365_mgmnt.startSubscription(collector.o365_mgmnt_client, stream));
